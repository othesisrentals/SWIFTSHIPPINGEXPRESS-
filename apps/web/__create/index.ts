...
// Removed unused import of contextStorage
...
let adapterInstance: ReturnType<typeof NeonAdapter> | undefined;
...
function getAdapter() {
  if (!pool) {
    ...
    adapterInstance = NeonAdapter(pool);
  }
  return adapterInstance!;
}

const adapter = new Proxy({} as ReturnType<typeof NeonAdapter>, {
  get(target, prop) {
    return getAdapter()[prop as keyof typeof adapterInstance];
  }
});
...
// app.use(contextStorage()); // removed unused contextStorage
