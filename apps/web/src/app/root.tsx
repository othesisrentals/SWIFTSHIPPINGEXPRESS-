...
export const meta = () => {
  return [
    { title: 'SwiftshipExpress - Connecting the World, One Shipment at a Time' },
    {
      name: 'description',
      content: 'SwiftshipExpress provides reliable global logistics with air freight, sea freight, land transport, and warehousing services. Track your shipment or request a quote today.',
    },
  ];
};
